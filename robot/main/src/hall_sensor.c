...
#define COUNTS_TO_RPM (60.0f / (SAMPLE_INTERVAL_MS / 1000.0f) / HALL_SENSOR_PULSES_PER_REV)
...
// Read by hall_sensor_get_rpm from any task (Core 1 weapon controller).
...
void hall_sensor_init(void)
{
    ...
    ESP_ERROR_CHECK(gpio_set_pull_mode(HALL_SENSOR_GPIO, GPIO_PULLUP_ONLY));
